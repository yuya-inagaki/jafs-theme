...
<div id="voice02">
  <div class="container">
    ...
    <!--吹き出しはじまり-->
    <?php if ($voice01 = get_option('voice_zoom01')) : ?>
      <br>
      <div class="balloon5">
        <div class="faceicon">
    ...
    <!--吹き出しはじまり-->
    <?php if ($voice02 = get_option('voice_zoom02')) : ?>
      <br>
      <div class="balloon5">
        <div class="faceicon">
    ...
    <!--吹き出しはじまり-->
    <?php if ($voice03 = get_option('voice_zoom03')) : ?>
      <br>
      <div class="balloon5">
        <div class="faceicon">
          <img style="pointer-events:none;" src="<?php echo get_template_directory_uri(); ?>/img/voice/voice-people01.jpg">
    ...
    <!--吹き出しはじまり-->
    <?php if ($voice04 = get_option('voice_zoom04')) : ?>
      <br>
      <div class="balloon5">
        <div class="faceicon">
          <img style="pointer-events:none;" src="<?php echo get_template_directory_uri(); ?>/img/voice/voice-people02.jpg">
    ...
    <!--吹き出しはじまり-->
    <?php if ($voice05 = get_option('voice_zoom05')) : ?>
      <br>
      <div class="balloon5">
        <div class="faceicon">
          <img style="pointer-events:none;" src="<?php echo get_template_directory_uri(); ?>/img/voice/voice-people01.jpg">
...
<style type="text/css">
  #voice01 {
    width: 100%;
    background: linear-gradient(rgba(158, 233, 255, 0.28) 50%, rgba(73, 227, 255, 0.69) 100%), url('<?php echo get_template_directory_uri(); ?>/img/voice/header-back.jpg') bottom/cover;
    position: relative;
  }
